...
fs.writeFileSync("../../Ansible/playbooks/master.sh",
                 "ansible-playbook -s --extra-vars \'MASTER_YES=\"true\" USER=\"root\" SPARK_URL=\"\" MASTER_IP=\""+ipAddress+"\"\' sparkplaybook.yml -i master_inventory\n")

fs.writeFileSync("../../Ansible/playbooks/slave.sh",
                 "ansible-playbook -s --extra-vars \'MASTER_YES=\"false\" USER=\"root\" SPARK_URL=\"spark://"+ipAddress+":7077\" MASTER_IP=\"\"\' sparkplaybook.yml -i slave_inventory\n")
